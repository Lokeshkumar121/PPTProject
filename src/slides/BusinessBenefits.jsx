...
const BusinessBenefits = () => {
  const benefits = ['🎯 Local audience tak reach', '🔍 Business discovery', '💻 Digital presence', '👥 Local customers', '🤝 Community engagement'];

  return (
    <div className="w-full h-full flex items-center justify-center px-16 py-20">
      <div className="max-w-4xl w-full">
        <SlideHeading icon={Store}>Benefits for Local Businesses</SlideHeading>
